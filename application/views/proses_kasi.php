          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="<?php echo site_url('auth/proses_kasi_action') ?>" method='POST'>
                    <div class="row">
                      <div class="col-md-12">
                    ...
                    <input type="submit"  value='ajukan' class="btn btn-primary pull-right"></input>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-danger">
                  <h4 class="card-title">Kembalikan ke Kasubsi</h4>
                  <p class="card-category">Berikan Catatan Pengembalian</p>
                </div>
                <div class="card-body">
                  <form action="<?php echo site_url('auth/kembalikan_kasubsi') ?>" method='POST'>
                    ...
                    <input type="text" style="display:none"  value='<?php echo $utama->id ?>' name="id"></input>                
                    <input type="text" style="display:none"  value='21' name="stat_loket"></input>
