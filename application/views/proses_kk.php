          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="<?php echo site_url('auth/proses_kk_action') ?>" method='POST'>
                    <div class="row">
                      <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="text-danger">Petugas BC</label>
                          <div class="form-group">
                            <label class="bmd-label-floating" >Tunjuk Petugas BC</label>
                            <input class="form-control" value="<?php echo $utama->petugas ?>" name="petugas" rows="5"></input>
                          </div>
                        </div>
                      </div>
                    </div>
                    <input type="text" style="display:none"  value='9' name="stat_loket"></input>
                    <input type="hidden"  value='<?php echo date("Y-m-d h:i:s") ?>' name="wk_selesai"></input>
                    <input type="submit"  value='setujui' class="btn btn-primary pull-right"></input>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-danger">
                  <h4 class="card-title">Kembalikan ke Kasi</h4>
                  <p class="card-category">Berikan Catatan Pengembalian</p>
                </div>
                <div class="card-body">
                  <form action="<?php echo site_url('auth/kembalikan_kasi') ?>" method='POST'>
                    ...
                    <input type="text" style="display:none" value='31' name="stat_loket"></input>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-danger">
                  <h4 class="card-title">Tolak Persetujuan</h4>
                  <p class="card-category">Berikan Catatan Penolakan</p>
                </div>
                <div class="card-body">
                  <form action="<?php echo site_url('auth/tolak_permohonan') ?>" method='POST'>

                    <div class="form-group">
                      <label class="bmd-label-floating"  >Masukan Catatan </label>
                            <textarea class="form-control"  name="catatan"  rows="5" ></textarea>
                    
                    </div>  
                    <input type="hidden"  value='<?php echo $utama->id ?>' name="id"></input>                
                    <input type="text" style="display:none" value='7' name="stat_loket"></input>
                    <input type="submit"  value='Tolak Permohonan' class="btn btn-danger pull-right"></input>
