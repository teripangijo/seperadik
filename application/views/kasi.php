            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Permohonan Masuk Kasi</h4>
                </div>
                <div class="card-body">
                      ...
                      <?php 
                         ...
                         foreach ($kembali as $back) {
                           ...
                           <tr>
                            ...
                            <td><a  class="btn btn-sm btn-success" href="<?php echo base_url('auth/proses_kasi.html?id='.$back->id) ?>" class="text-white">Proses</a></td>
                          </tr>
