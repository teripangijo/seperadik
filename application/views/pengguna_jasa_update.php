                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                              <label for="inputIzin">Jenis Izin</label>
                                  <select id="inputIzin" name="jenisdok" value="<?php echo $utama->jenisdok ?>" class="form-control">
                                    <option selected="" value="<?php echo $utama->jenisdok ?>"><?php 
                            $stat = $utama->jenisdok;
                            switch ( $stat ) {
                              case "1":
                                  echo 'Bongkar';
                              ...
                              case "3":
                                  ...
                                  break;
                                    ...
                                    <option value="2" >Timbun</option>
                                    <option value="3" >Muat</option>
                                  </select>
                        </div>
                      </div>
                      <div class="col-md-3">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name='nama' list="data_perusahaan" id="nama" onchange="return autofill();" value="<?php echo $utama->namapersh ?>" class="form-control">
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="alamat" id="alamat" value="<?php echo $utama->alamat ?>" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">NPWP Perusahaan</label>
                          <input type="text" id="npwp" value="<?php echo $utama->npwp ?>" name= 'npwp' class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input id="datepicker"  value="<?php echo tgl_dp($utama->tglmohon) ?>" name="tglmohon" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" id="datepicker2" value="<?php echo tgl_dp($utama->tgl_kira_muat) ?>" name="tgl_kira_muat" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
