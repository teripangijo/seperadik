...
<body class=""  style="background-image: url('<?php echo base_url();?>images/pelabuhan.png'); background-size: cover; background-position: center;">
  ...
  <!-- End Navbar -->
  <div style="overflow: visible;" filter-color="black" class="wrapper wrapper-full-page">
    <div class="page-header  header-filter"  >
      <!--   you can change the color of the filter page using: data-color="blue | purple | green | orange | red | rose " -->
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto" style="margin-top: 50pt">
            <img  style="display: block;
  margin-left: auto;
  margin-right: auto;width: 35%;" src="<?php echo base_url();?>images/logo.png"></img></br>
            <p style="font-family: sans-serif; text-align: center;">
            <font size='5' s>SEPERADIK </font><font size='5'  >V</font><font size='4'  >.2</font></p>
            <form class="form" method="POST" action="<?php echo site_url('auth/cari_status')?>">
              <div class="card card-login">
                <div class="card-header card-header-info text-center">
                  <div class="social-line">
                      <h4>PENCARIAN STATUS</h4>
                  </div>
                </div>
                <div class="card-body ">
                      ...
                      <div class="input-group-prepend">
                        <span class="input-group-text">
                          <i class="material-icons">event_note</i>
                           ...
                           <input type="text" class="form-control" name='keyword' placeholder="Nomor Surat"></input>
                      
                          <input type="submit" class="btn btn-sm btn-warning" value="cari"></input>
                      </div>
                    </div>
                </div> 
              </div>
                ...
                <button class="col text-center btn btn-success " onclick="window.location.href = '<?php echo site_url('auth/pengguna_jasa')?>';" class="text-white">
                        <i class="material-icons" >assignment</i>Pengajuan Permohonan</a>
                </button>
                <button class="col text-center btn btn-danger"  onclick="window.location.href = '<?php echo site_url('auth/login')?>';" class="text-white">
                        <i class="material-icons" >person</i>Login Pegawai</a>
                </button>
              </div>
            </div>
        ...
        <div class="container">
          <nav class="float-left">
            <ul>
              <li>
                <a href="http://bcpangkalpinang.beacukai.go.id/" class="text-white"> 
