            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  ...
                  <p class="card-category">Periksa Data dan Tunjuk Petugas Pengawasan</p>
                </div>
                <div class="card-body">
                  <form action="<?php echo site_url('auth/proses_pemeriksa_action') ?>" method='POST'>
                    <div class="row">
                      <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="text-success">Alasan 1</label>
                          <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="text-success">Alasan 2</label>
                          <div class="form-group">
                            <label class="bmd-label-floating" >Masukan Alasan Anda</label>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input id="datepicker3" autocomplete="off" type="text" name="tp2"  value="<?php echo $utama->tp2 ?>"  class="form-control datetimepicker">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control" value="<?php echo $utama->hasilp2 ?>" name="hasilp2" rows="5"></input>
                          </div>
                        </div>
                      </div>
                    </div>

                    <input type="text" style="display:none" value='2' name="stat_loket"></input>
                    <input type="submit"  value='ajukan' class="btn btn-success pull-right"></input>
                  </form>
                  <button onclick="window.location.href = '<?php echo site_url('auth/pemeriksa')?>';" class="btn btn-danger pull-right">Kembali</button>
                </div>
              </div>
            </div>
