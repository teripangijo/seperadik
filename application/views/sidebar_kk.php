...
<body class="">
   ...
   <!-- Sidebar -->
  <div class="wrapper ">
    <div class="sidebar" data-color="danger" data-background-color="black" data-image="<?php echo base_url('images/BCPAPIN.png') ?>">
      <div class="logo">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="<?php echo site_url('auth/browse_status_kk') ?>">
